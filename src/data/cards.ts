...
export const cardData: CardDef[] = [
  ...
  },
  {
    ...
    fact: 'Your phone has tiny bits of real gold dug from a mine deep underground!',
    color: '#FFE5F0',
    rarity: 'Uncommon',
    awardedBy: 'wild-earth',
  },
  {
    id: 'power-ranger',
    skill: 'Foundations',
    emoji: '⚡',
    title: 'Power Pro',
    fact: 'One bolt of lightning could toast about 100,000 slices of bread!',
    color: '#FFE5F0',
    rarity: 'Uncommon',
    awardedBy: 'power-core',
  },
  {
    id: 'machine-master',
    skill: 'Foundations',
    ...
    fact: 'A chip smaller than your fingernail holds billions of tiny on/off switches!',
    color: '#FFE5F0',
    rarity: 'Rare',
    awardedBy: 'machine-forge',
  },
  {
    id: 'master-builder',
    skill: 'Operations',
    ...
    fact: 'The Burj Khalifa is so tall you can watch the sunset twice — top floor, then bottom!',
    color: '#FFE5F0',
    rarity: 'Uncommon',
    awardedBy: 'mega-build',
  },
  {
    id: 'cloud-captain',
    skill: 'Foundations',
    emoji: '💻',
    title: 'Cloud Captain',
    fact: 'The "cloud" is really giant warehouses of computers — sometimes across the ocean!',
    color: '#FFE5F0',
    rarity: 'Rare',
    awardedBy: 'digital-universe',
  },
  {
    id: 'route-runner',
    skill: 'Operations',
    emoji: '🛒',
    title: 'Route Runner',
    fact: 'The biggest cargo ships are longer than 4 football fields!',
    color: '#FFE5F0',
    rarity: 'Uncommon',
    awardedBy: 'trade-routes',
  },
  {
    id: 'wisdom-keeper',
    skill: 'Foundations',
    emoji: '📚',
    title: 'Wisdom Keeper',
    fact: 'Learning is a real business — even this app is part of the education world!',
    color: '#FFE5F0',
    rarity: 'Uncommon',
    awardedBy: 'wisdom-academy',
  },
  {
    id: 'council-keeper',
    skill: 'Giving',
    emoji: '🏛️',
    title: 'Council Keeper',
    fact: 'Fire hydrants connect to giant underground pipes paid for by everyone\'s taxes!',
    color: '#FFE5F0',
    rarity: 'Uncommon',
    awardedBy: 'civilization-council',
  },
  {
    id: 'life-saver',
    skill: 'Foundations',
    emoji: '💊',
    title: 'Life Saver',
    fact: 'Some medicines spend 10+ years in testing — longer than you\'ve been alive!',
    color: '#FFE5F0',
    rarity: 'Rare',
    awardedBy: 'healing-life',
  },
  {
    id: 'frontier-pioneer',
    skill: 'Foundations',
    ...
    fact: 'Some rockets land themselves and blast off again — like reusing a toy!',
    color: '#FFE5F0',
    rarity: 'Legendary',
    awardedBy: 'future-frontier',
  },
  {
    id: 'entrepreneur',
    skill: 'Foundations',
